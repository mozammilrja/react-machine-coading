...
import Zomato from "./Components/Pages/Questions/TopicAndCompany/Zomato";
import TodoApp from "./Components/Pages/Questions/TodoApp/Index";
  ...
  const router = createBrowserRouter([
...

    {
      ...
      children: [
        ...
        {
          path: "/auth/interview-questions/quest-1",
          element: <Zomato />,
        },
        {
          path: "/auth/interview-questions/quest-2",
          element: <TodoApp />,
        },
        {
